...
while(True):
    ...
    c.execute('insert into datalogger_humiditymeassurement \
        (sample_value, sample_date) values (?, ?)', (humidity, now, ))
    c.execute('insert into datalogger_temperaturemeassurement \
        (sample_value, sample_date) values (?, ?)', (celsTemp, now, ))
